...
const APP_META = {
  name: "RON SCRIPTS",
  version: "2.1.4",
  build: "RON-ULTIMATE-VIP-2026.08.24.1",
  channel: "ULTIMATE",
...
const customScriptSkins = [
  ...
  { id: "custom_argus_meliodas", title: "Argus x Meliodas — Demon Mark", hero: "Argus", type: "Custom", tags: ["meliodas", "demon", "mark"], customOnly: true, preserveDefault: true, description: "Custom concept centered on a black-green demon aura, glowing blade accents, and burst slashes." },
...
const realLinkSkins = [
  ...
  { id: "real_argus_meliodas", title: "Argus x Meliodas — Real Script", url: "https://sfile.co/bPzuZb4ngls", hero: "Argus", type: "Crossover", tags: ["meliodas", "seven-deadly-sins", "verified-link"], sourceVerified: true, preserveDefault: true },
...
const heroVault = [
  ...
  // =========================================================
  // VERIFIED REAL-LINK ADDITIONS — 2.1.4
...
function bootUI() {
  try {
    ...
    if (result) result.textContent = "Library failed to start. Reload once or open Tester for diagnostics.";
  }
}
